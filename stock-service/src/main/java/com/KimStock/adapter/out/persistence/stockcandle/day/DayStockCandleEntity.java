...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "day_stock_candle")
public class DayStockCandleEntity {
    ...
    public static DayStockCandleEntity of(StockCandle stockCandle) {
        return DayStockCandleEntity.builder()
