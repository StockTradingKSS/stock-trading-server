...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "week_stock_candle")
public class WeekStockCandleEntity {
    ...
    public static WeekStockCandleEntity of(StockCandle stockCandle) {
        return WeekStockCandleEntity.builder()
