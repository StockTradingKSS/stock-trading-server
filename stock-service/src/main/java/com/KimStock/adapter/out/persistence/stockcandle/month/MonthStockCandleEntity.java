...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "month_stock_candle")
public class MonthStockCandleEntity {
    ...
    public static MonthStockCandleEntity of(StockCandle stockCandle) {
        return MonthStockCandleEntity.builder()
