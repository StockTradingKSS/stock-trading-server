package com.kokimstocktrading.adapter.out.external.kiwoom.config;
...
public class KiwoomWebClientConfig {
    ...
    public WebClient kiwoomInvestmentWebClient() {
        ...
        // Connection Pool 설정
        ConnectionProvider connectionProvider = ConnectionProvider.builder("kiwoom-investment-connection-pool")
                .maxConnections(500)
