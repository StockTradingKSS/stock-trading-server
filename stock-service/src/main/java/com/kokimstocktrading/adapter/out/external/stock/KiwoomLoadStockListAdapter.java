...
public class KiwoomLoadStockListAdapter implements LoadStockListPort {
   ...
   * @return 종목 정보 응답
   */
  public Mono<List<Stock>> loadStockInfoListBy(MarketType marketType, String contYn,
      String nextKey) {
  ...
  private Mono<List<StockInfoResponse.StockItem>> loadStockInfoListApi(String token,
      StockInfoRequest stockInfoRequest, String contYn, String nextKey) {
