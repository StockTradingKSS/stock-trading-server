package com.kokimstocktrading.application.order.port.out;
...
public interface RequestStockOrderPort {
   ...
   * @return 주문 결과
   */
  Mono<OrderResult> requestBuyStock(String stockCode, int quantity, double price,
      TradeType tradeType);
   ...
   * @return 주문 결과
   */
  Mono<OrderResult> requestSellStock(String stockCode, int quantity, double price,
      TradeType tradeType);
   ...
   * @return 주문 결과
   */
  Mono<OrderResult> requestModifyOrder(String orderNo, String stockCode, int quantity,
      double price);
